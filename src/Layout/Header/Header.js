...
//logo được chuyển đổi từ chuỗi svg thành một thẻ

let svgColor = localStorage.getItem('selectedTheme');
const logo = `<svg
  ...
  >
    <path
      fill= ${svgColor == 'light' ? '#25F4EE' : '#fff'}
    ...
    ></path>
    <path
      fill=${svgColor == 'light' ? '#FE2C55' : '#fff'}
